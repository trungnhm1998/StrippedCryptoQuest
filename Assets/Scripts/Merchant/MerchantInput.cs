...
{
    [CreateAssetMenu(menuName = "Create MerchantInput", fileName = "MerchantInput", order = 0)]
    public class MerchantInput : ScriptableObject, InputActions.IMerchantsActions
    {
