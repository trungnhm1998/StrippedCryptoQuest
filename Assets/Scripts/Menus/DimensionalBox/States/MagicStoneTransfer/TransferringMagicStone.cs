...
namespace CryptoQuest.Menus.DimensionalBox.States.MagicStoneTransfer
{
    ...
    //
    //         Menu.Input.MenuExecuteEvent += ConfirmTransfer;
    //         Menu.Input.MenuNavigateEvent += MoveBetweenList;
    //         Menu.Input.MenuResetEvent += ResetToOriginals;
    //
    ...
    //         Menu.ChangeState(Menu.ConfirmMagicStoneTransfer);
    //     }
    //
