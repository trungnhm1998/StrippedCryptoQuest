...
namespace CryptoQuest.Menus.DimensionalBox.States.MagicStoneTransfer
{
    ...
    //     {
    //         Menu.Input.MenuCancelEvent += OnNoButton;
    //         if (_dialog == null)
    //         {
    ...
    //
    //         var magicStoneController = Menu.MagicStoneTransferPanel.GetComponent<MagicStoneController>();
    //
    ...
    //         Menu.ChangeState(Menu.TransferringMagicStoneState);
    //     }
    // }
}