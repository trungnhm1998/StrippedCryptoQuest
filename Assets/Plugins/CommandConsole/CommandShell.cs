...
namespace CommandTerminal
{
    ...
    public class CommandShell
    {
        ...
        {
#if UNITY_WEBGL
            name = Regex.Replace(name, "command", "", RegexOptions.IgnoreCase);
#endif
            name = name.ToUpper();
        ...
        public void AddCommand(string name, Action<CommandArg[]> proc, int min_args = 0, int max_args = -1,
            string help = "", string hint = null)
        {
