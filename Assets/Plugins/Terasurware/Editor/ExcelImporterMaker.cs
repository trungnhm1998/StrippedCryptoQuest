...
public class ExcelImporterMaker : EditorWindow
{
                ...
                for (int i = 0; i < titleRow.LastCellNum; i++)
                {
                    ...
                    if (cell.CellType != CellType.Unknown && cell.CellType != CellType.Blank)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                parser.type =
                                    (ValueType)EditorPrefs.GetInt(s_key_prefix + window.fileName + ".type." +
                                                                  parser.name);
                            }
                            else
                            {
    ...
    void ExportEntity()
    {
        string templateFilePath = (sepalateSheet)
            ? "Assets/Plugins/Terasurware/Editor/EntityTemplate2.txt"
            : "Assets/Plugins/Terasurware/Editor/EntityTemplate.txt";
        ...
        Directory.CreateDirectory("Assets/Plugins/Terasurware/Classes/");
        File.WriteAllText("Assets/Plugins/Terasurware/Classes/" + className + ".cs", entittyTemplate);
    }

    void ExportImporter()
    {
        string templateFilePath = (sepalateSheet)
            ? "Assets/Plugins/Terasurware/Editor/ExportTemplate2.txt"
            : "Assets/Plugins/Terasurware/Editor/ExportTemplate.txt";
