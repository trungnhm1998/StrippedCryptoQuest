    ...
    public void OnSelect(BaseEventData eventData)
    {
        ...
        if (GameMenu.instance.skillsMenu.activeInHierarchy)
        {
            if (GameMenu.instance.skillButtons[buttonValue].gameObject.activeInHierarchy)
            {
                ...
                {
                    if (GameMenu.instance.skillButtons[buttonValue].skill == BattleManager.instance.skillList[i].skillName)
                    {
                        GameMenu.instance.skillDescription.text = BattleManager.instance.skillList[i].description;
                        GameMenu.instance.skillButtons[buttonValue].usableInMenu = BattleManager.instance.skillList[i].heal;
                        //GameMenu.instance.skillButtons[buttonValue].usableInMenu = BattleManager.instance.skillList[i].healStatusEffects;
                        GameMenu.instance.skillButtons[buttonValue].healStatusEffects = BattleManager.instance.skillList[i].healStatusEffects;
                        GameMenu.instance.skillButtons[buttonValue].skillPower = BattleManager.instance.skillList[i].skillPower;
                    }
                }
            }
        }
        ...
        if (BattleManager.instance.skillMenu.activeInHierarchy)
        {
            for (int i = 0; i < BattleManager.instance.skillList.Length; i++)
            {
                if (BattleManager.instance.skillButtons[buttonValue].skill == BattleManager.instance.skillList[i].skillName)
                {
                    BattleManager.instance.skillDescriptionText.text = BattleManager.instance.skillList[i].description;
                    BattleManager.instance.skillButtons[buttonValue].usableInMenu = BattleManager.instance.skillList[i].heal;
                    BattleManager.instance.skillButtons[buttonValue].healStatusEffects = BattleManager.instance.skillList[i].healStatusEffects;
                    BattleManager.instance.skillButtons[buttonValue].skillCost = BattleManager.instance.skillList[i].skillCost;
                    BattleManager.instance.skillButtons[buttonValue].skillPower = BattleManager.instance.skillList[i].skillPower;
