...
public class GameMenu : MonoBehaviour {
    ...
    public GameObject[] menuCharacterSlotsSecondary;
    ...
    public List<CharacterStatus> secondaryplayerStats;
    ...
    public Image[] charImage, charImageItem, charImageStatus, charImageSecondary;
    ...
    public void UpdateMainStats()
    {
        ...
        foreach (CharacterStatus character in GameManager.instance.characterStatus)
        {
            if (!character.gameObject.activeInHierarchy && !secondaryplayerStats.Contains(character))
            {
                secondaryplayerStats.Add(character);
            }
        }

        for (int i = 0; i < secondaryplayerStats.Count; i++)
        {
            if (secondaryplayerStats[i].activeInParty)
            {
                menuCharacterSlotsSecondary[i].SetActive(true);
                charImageSecondary[i].sprite = secondaryplayerStats[i].characterIamge;
            }            
        }
    ...
    public void CloseMenu()
    {
        ...
        for (int i = 0; i < menuCharacterSlotsSecondary.Length ; i++)
        {
            menuCharacterSlotsSecondary[i].SetActive(false);
        }
        
        playerStats.Clear();
        secondaryplayerStats.Clear();
    }
