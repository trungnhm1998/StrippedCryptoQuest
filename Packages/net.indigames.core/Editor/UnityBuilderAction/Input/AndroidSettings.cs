...
namespace IndiGamesEditor.UnityBuilderAction.Input
{
    public static class AndroidSettings
    {
        public static void Apply(Dictionary<string, string> options)
        {
            ...
            if (options.TryGetValue("androidTargetSdkVersion", out androidTargetSdkVersion) &&
            ...
            if (options.TryGetValue("androidExportType", out androidExportType) &&
